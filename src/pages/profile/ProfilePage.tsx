              ...
              <form onSubmit={handleUpdateInfo} className="space-y-5 max-w-xl">
                <div>
                  ...
                  <p className="text-[10px] text-on-surface-variant/70 mt-1">
                    Email không thể chỉnh sửa để đảm bảo tính an toàn của tài
                    khoản.
                  </p>
                </div>
              ...
              {ordersLoading ? (
                ...
                <div className="py-16 text-center text-on-surface-variant">
                  ...
                  {orderFilter !== "all" ? (
                    ...
                    <Link
                      to="/shop"
                      className="btn btn-primary btn-pill text-xs"
                    >
                      Mua sắm ngay
                    </Link>
                  )}
                      ...
                      <div className="py-4 space-y-3">
                        {order.items?.map((item: any, idx) => {
                          ...
                          const brand = isPopulated
                            ...
                            : "Sneaker Vault";
                          const image =
                            isPopulated && item.product.images?.length > 0
            ...
            <div className="space-y-3">
              ...
              <div>
                <label className="form-label">
                  Địa chỉ chi tiết (Số nhà, đường, quận, thành phố)
                </label>
                <textarea
                  required
                  rows={3}
