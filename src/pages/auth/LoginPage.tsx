  ...
  return (
    <main className="pt-24 md:pt-0 min-h-screen flex flex-col md:flex-row">
      ...
      <section className="hidden md:block w-1/2 h-screen sticky top-0 bg-surface-container-highest overflow-hidden">
        <div className="absolute inset-0 z-10 bg-linear-to-t from-black/40 to-transparent"></div>
        <img
      ...
      <section className="flex-1 flex flex-col justify-center items-center px-margin-mobile md:px-margin-desktop py-12 bg-background">
        <div className="w-full max-w-md">
          ...
          <div className="flex gap-8 mb-12 border-b border-outline-variant/30">
            <button className="font-label-md text-label-md uppercase tracking-widest text-on-surface border-b-2 border-on-surface pb-4">
              Login
            </button>
            <button
              onClick={handleRegister}
              className="font-label-md text-label-md uppercase tracking-widest text-on-surface-variant hover:text-on-surface pb-4 transition-all"
            >
              Register
            </button>
          </div>
